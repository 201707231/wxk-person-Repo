...
<!--          <img src="@/assets/img/userimg.png" class="user-img" ref="img" @click="showSetting()" />-->
          <i class="el-icon-setting" style="margin-top: 32px;margin-left: 15px" @click="showSetting()"></i>
          <transition name="fade">
            <div class="out" ref="out" v-show="login_flag" style="width: 56px">
              <ul>
                <li><a href="javascript:;" @click="showMes()">用户信息</a></li>
                <li><a href="javascript:;" @click="updatePwd()">修改密码</a></li>
