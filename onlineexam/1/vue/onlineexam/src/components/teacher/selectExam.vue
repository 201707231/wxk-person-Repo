...
<template>
  <div class="exam">
    <ul class="top">
      ...
      <li><el-button type="primary" @click="getExamInfo()">查询全部</el-button></li>
    </ul>
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="examDate" label="考试日期" width="120" sortable></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <a @click="edit(scope.row.examCode)">编辑</a>
          <a @click="deleteRecord(scope.row.examCode)">删除</a>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
