...
<template>
  <div class="all">
    <ul class="top">
      <li class="search-li"><div class="icon"><input type="text" placeholder="考生名称" class="search" v-model="key"><i class="el-icon-search"></i></div></li>
      <li><el-button type="primary" @click="search()">搜索考生</el-button></li>
      <li><el-button type="primary" @click="getStudentInfo()">查询全部</el-button></li>
    </ul>
    <el-table :data="pagination.records" border>
      <el-table-column fixed="left" prop="studentName" label="姓名" width="180" ></el-table-column>
      <el-table-column prop="institute" label="学院" width="200"></el-table-column>
      <el-table-column prop="major" label="专业" width="200"></el-table-column>
      <el-table-column prop="grade" label="年级" width="200" sortable></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <a @click="checkGrade(scope.row.studentId)">编辑</a>
          <a @click="deleteById(scope.row.studentId)">删除</a>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
