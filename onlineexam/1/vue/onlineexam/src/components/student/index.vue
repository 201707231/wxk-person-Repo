    ...
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          ...
          <li><a href="javascript:;" @click="practice()">题目解析</a></li>
          <li><router-link to="/scoreTable">成绩查询</router-link></li>
          <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag"><!--鼠标进入显示下拉菜单-->
            <a href="javascript:;"><i class="iconfont icon-Userselect icon"></i>{{user.userName}}</a>
            <div class="msg" v-if="flag">
              <p @click="manage()">修改密码</p>
              <p @click="showMes()">个人信息</p>
  ...
  methods: {
    ...
    exam() { //跳转考试模式
     let isPractice = false
      ...
      showMes(){
          this.$router.push({path: '/studentMsg'})
      }
  },
