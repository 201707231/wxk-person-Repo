...
public class CommonUtil {
    ...
    public static void fixParams(JSONObject json,String... paramName){
        for (int i = 0; i < paramName.length; i++) {
            if(!json.containsKey(paramName[i]))
                json.put(paramName[i], "");
        }
    }
    public static void fixParams(JSONObject json,HashMap<String,String> map){
